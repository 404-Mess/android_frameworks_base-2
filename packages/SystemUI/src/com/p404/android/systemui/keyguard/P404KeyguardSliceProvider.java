package com.p404.android.systemui.keyguard;
...
public class P404KeyguardSliceProvider extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    public Slice onBindSlice(Uri uri) {
        ...
        Trace.beginSection("P404KeyguardSliceProvider#onBindSlice");
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        private final WeakReference<P404KeyguardSliceProvider> mProviderReference;
        private final SmartSpaceCard mWeatherCard;

        AddShadowTask(P404KeyguardSliceProvider p404KeyguardSliceProvider, SmartSpaceCard smartSpaceCard) {
            this.mProviderReference = new WeakReference<>(p404KeyguardSliceProvider);
            this.mWeatherCard = smartSpaceCard;
            this.mBlurRadius = p404KeyguardSliceProvider.getContext().getResources().getDimension(R.dimen.smartspace_icon_shadow);
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            P404KeyguardSliceProvider p404KeyguardSliceProvider;
            synchronized (this) {
                this.mWeatherCard.setIcon(bitmap);
                p404KeyguardSliceProvider = this.mProviderReference.get();
            }
            if (p404KeyguardSliceProvider != null) {
                p404KeyguardSliceProvider.notifyChange();
            }
        }
